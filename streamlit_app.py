...
with st.sidebar:
    ...
    with col2:
        st.markdown("<div style='padding: 1rem; color: #0d6efd; font-weight: 600; font-size: 0.9rem;'>Sistema seguro y eficiente para la gestión de uniformes.</div>", unsafe_allow_html=True)
